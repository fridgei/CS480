...
E2 = match_tokens([Token('', 'OF_ADD', ''), Token('', 'OF_SUB', ''),
                   Token('','OF_DIV', ''), Token('', 'OF_MUL', ''),
                   Token('', 'OF_LT', ''), Token('', 'OF_GT', ''),
                   Token('', 'OF_EQ', ''), Token('', 'OF_POW', ''),
                   Token('', 'OF_MOD', '')])
B1 = match_tokens([Token('', 'OB_NOT', '')])
B2 = match_tokens([Token('', 'OB_AND', ''), Token('', 'OB_OR', ''),
                   Token('', 'OB_IFF', '')])
ATOM = match_tokens([Token('', 'V_BOOL', ''), Token('', 'V_INT', ''),
                     Token('', 'V_REAL', ''), Token('', 'V_E', '')])
